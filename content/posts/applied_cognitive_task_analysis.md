...
lastmod = 2026-01-10T22:44:00-08:00
draft = false
slug = "31152f53-1769-454c-be11-643a5405eb5d"
+++

Applied cognitive task analysis, as outlined in Laura Militello and Robert Hutton | Applied Cognitive Task Analysis (ACTA): A Practitioner's Toolkit for Understanding Cognitive Task Demands, is a technique for extracting expertise which is simpler than Cognitive task analysis. There are four steps:

1.  Create a [Task diagram](#task-diagram)
    1.  Ask the subject matter expert to decompose the task in to steps, or subtasks, into 3-6{{< sidenote >}}"The interviewer limits the SME to between three and six steps, to ensure that time is not wasted delving into minute detail during the surface-level interview." (<a href="#citeproc_bib_item_2">Militello and Hutton 1998</a>){{< /sidenote >}}steps
